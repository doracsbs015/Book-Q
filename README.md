...
When a book has no copies left, users can join a reservation queue. The moment someone returns it, the next person in line gets auto-assigned and no manual intervention needed.
